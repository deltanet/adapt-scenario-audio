...
class ScenarioView extends ComponentView {
  ...
  events() {
    return {
      ...
      'swipeleft .js-scenario-audio-swipe': 'onSwipeLeft',
      'swiperight .js-scenario-audio-swipe': 'onSwipeRight'
    };
  }
  ...
  shouldShowInstructionError() {
    ...
    this.$('.scenario-audio__instruction-inner').addClass('instruction-error');
  }
...
ScenarioView.template = 'scenario';
